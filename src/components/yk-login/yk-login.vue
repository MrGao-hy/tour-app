	...
	<view class="normal-login-container">
		...
		<view class="login-form-content">
			...
			<view class="action-btn">
				<u-button class="login-btn" :color="props.themeColor" @click="loginFn"
					>登录
				</u-button>
			</view>
			<view class="footer">
...
const loginFn = async () => {
	...
	switch (type) {
		case "user":
			...
			const uuid = uni.getStorageSync(config.prefix + "uuid");
			...
			emit("login", Object.assign(userForm.value, { uuid }));
			break;
		case "phone":
